...
%% main loop
    if frame > 1
        pos_pre=pos;
        [xtf,xtf_m,pos,translation_vec] = run_detection(im,pos,sz,target_sz,currentScaleFactor,features,cos_window,g_f,g_f_m,global_feat_params,use_sz,ky,kx,newton_iterations,featureRatio,Vy,Vx,params.weight);
        Vy=pos(1)-pos_pre(1);
        Vx=pos(2)-pos_pre(2);
